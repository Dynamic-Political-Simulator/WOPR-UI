...
function GameManager() {
    ...
    useEffect(() => {
        ...
        fetch(process.env.REACT_APP_BASE_URL + "saves/list-saves", requestInit)
    ...
    function parseSave(name: string) {
        ...
        fetch(process.env.REACT_APP_BASE_URL + "saves/parse-save?name=" + name, requestInit)
    ...
    function uploadPop() {
        ...
        readFileDataAsBase64(save).then(result => {
            ...
            fetch(process.env.REACT_APP_BASE_URL + "saves/upload-pop", requestInit)
                .catch(() => setError("Something went wrong, try again."))
                .then(() => setProcessing(false));
        });
    }
    ...
    function uploadEmpire() {
        ...
        readFileDataAsBase64(save).then(result => {
            ...
            fetch(process.env.REACT_APP_BASE_URL + "saves/upload-empire", requestInit)
                .catch(() => setError("Something went wrong, try again."))
                .then(() => setProcessing(false));
        });
    }
    ...
    function parseData() {
        ...
        fetch(process.env.REACT_APP_BASE_URL + "saves/parse-data", requestInit)
            .catch(() => setError("Something went wrong, try again."))
            .then(() => setProcessing(false));
    }
    ...
    function runCalc() {
        ...
        fetch(process.env.REACT_APP_BASE_URL + "saves/calculate", requestInit)
            .catch(() => setError("Something went wrong, try again."))
            .then(() => setProcessing(false));
    }
